...
var CesiumMaps = (function() {
    ...
    _.createMap = function(lat, lng, zoom, div, callback, failure) {
        ...
        if(Cesium) {
            var globe = new _.Globe(div, lat, lng, zoom);
            callback(globe);
        } else {
            failure();
        }
    ...
    _.Globe = function(container, lat, lng, zoom) {
        ...
        var bingMapsAPI = 'AnWRhVJTAYmWG0laRFk_Tq3nBxb4BM718C1IUyl0uCq1NkM9XlXkjKjDwNLMfTNf';
        var mapsIds = {
            "Bing Satellite Maps":
        ...
        var cesiumWidget = new Cesium.CesiumWidget(frameDiv, {
            imageryProvider: mapsIds["Bing Satellite Maps"],
            scene3DOnly: true
        });
